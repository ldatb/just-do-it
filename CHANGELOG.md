...
- chore: task todo list (98ef2c4)
- chore: update CHANGELOG.md for v1.2.0 (fb97df0)
## [1.2.0] - 2026-04-20

### Added

- feat: loop on review (d552147)

### Maintenance

- chore: update CHANGELOG.md for v1.1.0 (b8b1a22)
## [1.1.0] - 2026-04-13

### Added

- feat: cost and session limits improvements (9851129)

### Maintenance

- chore: user-centric approach (260ddd1)
- chore: update CHANGELOG.md for v1.0.0 (e74369f)
## [Unreleased]
