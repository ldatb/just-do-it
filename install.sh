...
echo ""
echo "  Quick Start:"
echo "    /do:go \"task\"     - Just do it. Minimal ceremony."
echo "    /do:start \"task\"  - Full pipeline (research, plan, build, verify)"
echo "    /do:help          - Show all commands"
echo ""
echo "  New Commands:"
echo "    /do:go            - Just do it. Skip ceremony, fast execution."
...
echo "  To just do it:           /do:go \"description\""
echo ""
